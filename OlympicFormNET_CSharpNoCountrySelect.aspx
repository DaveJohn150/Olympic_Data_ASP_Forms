        ...
        if (Request.Form["YearOfGames"] != null)
        {
            ...
            for (int r = 1; r < 26; r++)
            {
                ...
                if (!string.IsNullOrEmpty(varComp) && !string.IsNullOrEmpty(varMedal) && !string.IsNullOrEmpty(varRecord)) //if all are filled
                {
                    ...
                    if (!(varMedal.ToLower() == "g" || varMedal.ToLower() == "s" || varMedal.ToLower() == "b"))
                    {
                        rowError = true;
...
<table width="982" border="1">
  <tr>
    ...
    <td align="center"><select id="<%=country %>" name="<%=country %>" value="<%=Request.Form[country] %>">
...
<p>
  <input type="submit" name="button" id="button" value="Submit" />
    ...
    <%
        ...
        else //print the results
        {
            ...
            //----------------------------------------------------------------------------------------------------
                %>
    <h2><strong>Country Scoreboard:</strong></h2>
  ...
  <tr>
    ...
    <td width="80" align="center"><strong>Total</strong></td>
                    ...
                    <h2><strong>New World Records:</strong></h2>
    <table width="720" border="1">
        <tr>
